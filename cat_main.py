...
#DHI가 0인 행 제거
# list_zero = trainData["0afterDHI"] != 0
# list_one = trainData["1afterDHI"] != 0
# trainData = trainData[list_zero & list_zero]
# trainData =  trainData.drop(list_zero & list_one)
...
# 저장하고 평균 loss 출력
submission.to_csv('./subs/20210104_1612.csv', index=False)
