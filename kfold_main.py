...
from modules.load_mvag import load_mAvg_train,load_mAvg_test,add_mVag_data
...
moveTrain = add_mVag_data(changeTrain,days=3,select=[1,3],cols=cols,isTrain=True,includeRaw=True)
...
moveTest = add_mVag_data(changeTest,days=3,select=[1,3],cols=cols,isTrain=False,includeRaw=True)
# save_csv(moveTest)
#%%
